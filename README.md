...
Heuristic Adaptive PID: Features a non-linear control loop that dynamically boosts K 
p
​	
 and K 
d
​	
  gains by 1.5x when abs(error) > 10. This allows for smooth oscillation-free straight-line driving while providing aggressive torque response during acute cornering.
...
Pin Configuration: Ensure your hardware matches the pin definitions in the macro section:
